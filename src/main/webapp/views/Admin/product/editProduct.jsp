...
<section class="container">
    <div class="row p-5 mb-2 shadow-lg  bg-body-tertiary  rounded">
        <div class="col-12">
            <h3 class="text-center p-3 mb-5 mt-3">Edit Product</h3>
            <s:form action="editArticle" method="post">
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                <input id="ProductDescription" class="form-control" value="${article.codeArt}" name="article.codeArt" readonly/>
           </div>
          </div>
            ...
            <div class="form-group">
                ...
                <input id="ProductDescription" class="form-control" value="${article.descArt}" name="article.descArt" required/>
           </div>
          </div>
          ...
          <div class="col-md-6">
            <div class="form-group">
                ...
                <input type="text" class="form-control" value="${article.nomArt}"  name="article.nomArt" required/>
            </div>
            </div>
            <div class="col-md-6">
              <div class="form-group">
                <label for="productPrice">Product Price (DH)</label>
                <input id="productPrice" class="form-control" value="${article.prixArt}"  name="article.prixArt" required/>
       </div>
          ...
          <div class="col-md-6">
            <div class="form-group">
                ...
                <input type="number" id="quantity" class="form-control" value="${article.qteArt}" min="0" name="article.qteArt"/>
            </div>
              </div>
