...
<div class="row  mt-5 ml-5 p-5 position-relative col-8 justify-content-end ">
  ...
  <div class="col-sm-3">
    <select class="form-select" id="specificSizeSelect">
      <option selected>codeArt</option>
      <option >qteArt</option>
  ...
  <tbody >
   <s:iterator value="articlesList">
    <tr>
      ...
      <s:url namespace="/" action="deleteArt" var="delete">
	...
	<td><s:a href="%{delete}" class="btn btn-danger delete-btn" >delete</s:a></td>
	 ...
	 <s:url namespace="/" action="edit" var="edit">
	  <s:param name="codeart">
	    <s:property value="codeArt"/>
	  </s:param>
	</s:url>
	<td><s:a href="%{edit}" class="btn btn-success" >edit</s:a></td>
...
$(document).ready(function() {
	  $('#specificSizeInputGroupUsername').on('keyup', function() {
	    ...
	    var column = $('#specificSizeSelect').val() === 'codeArt' ? 0 : $('#specificSizeSelect').val() === 'qteArt' ? 1 : $('#specificSizeSelect').val() === 'nomArt' ? 2 :$('#specificSizeSelect').val() === 'descArt' ? 3:4 ;
